<template>
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        <!--查询--><el-button @click="getDataList()">查询</el-button>
        <!--新增--><el-button v-if="isAuth('manage:advertisement:save')" type="primary" @click="addOrUpdateHandle()">新增</el-button>
...
<!--        </el-button>-->
    ...
    <el-table
      ...
      <template slot-scope="scope">
        <!--模板跳转--><el-tag v-if="scope.row.jumpMode === 3" size="small" >板块跳转</el-tag>
        <!--内部跳转--><el-tag v-if="scope.row.jumpMode === 2" size="small" >内部链接</el-tag>
        <!--外部链接--><el-tag v-if="scope.row.jumpMode === 1" size="small">外部链接</el-tag>
      </template>
    </el-table-column>
      ...
      <el-table-column
        ...
        label="操作">
        <template slot-scope="scope">
          <!--修改--><el-button type="text" size="small" @click="addOrUpdateHandle(scope.row.id)">修改</el-button>
          <!--删除--><el-button type="text" size="small" @click="deleteHandle(scope.row.id)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
